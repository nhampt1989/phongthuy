...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <input type="date" id="start" name="trip-start" value="2022-09-28" max="2030-12-31">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $dateduong = test_input($_POST["trip-start"]);
    }
    ...
    $y1 = substr($dateduong,0, 4);
    $m1 = substr($dateduong,5, -3);
    $d1 = substr($dateduong,8, 2);
    $ngayam = alhn($d1,$m1,$y1);
