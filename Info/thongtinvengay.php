<!-- Tính ngày can chi mốc là 15/12/2022 âm
ngày 6 dương : Giáp Tý
Tháng 1 dương 
Năm 2022 : Nhâm Dần
-->
...
//Tìm ngày can chi khi biết ngày dương
function timcanchicuangay($ngay)
{
    ...
    $songay = 0;
    $first_date = strtotime('2023-1-6');
    $second_date = strtotime($ngay);
    $datediff = abs($first_date - $second_date);
    $songay = floor($datediff / (60 * 60 * 24));

    return $lucthaphoagiap[$songay % 60 + 1];
}
echo timcanchicuangay('2023-9-9');
